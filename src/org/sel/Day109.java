...
public class Day109 {
	public static void main(String[] args) throws InterruptedException, IOException, AWTException {
		...
		driver.findElement(By.xpath("//body/div[@id='container']/div[1]/div[1]/div[1]/div[2]/div[2]/form[1]/div[1]/div[1]/input[1]")).sendKeys("redmi phone");
		...
		WebElement txtPrice = driver.findElement(By.xpath("(//div[text()='₹8,999'])[1]"));
